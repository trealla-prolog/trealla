...
bench_mark(Name, Speedup) :-
	...
	assertz(bench_result(Name, NetTime)).
...
term64(X1) :-
   ...
   X16 = f(X32, X32a),
   X32 = f(X64, X64a),
   copy_term_nat(X2, X2a),		% Avoid cyclic term-reduction to
   copy_term_nat(X4, X4a),		% make this a no-op.
   copy_term_nat(X8, X8a),
   copy_term_nat(X16, X16a),
   copy_term_nat(X32, X32a),
   copy_term_nat(X64, X64a).
...
term4096(X1) :-
   ...
   copy_term_nat(X2, X2a),
   copy_term_nat(X4, X4a),
   copy_term_nat(X8, X8a),
   copy_term_nat(X16, X16a),
   copy_term_nat(X32, X32a),
   copy_term_nat(X64, X64a),
   copy_term_nat(X128, X128a),
   copy_term_nat(X256, X256a),
   copy_term_nat(X512, X512a),
   copy_term_nat(X1024, X1024a),
   copy_term_nat(X2048, X2048a),
   copy_term_nat(X4096, X4096a).
