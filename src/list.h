...
inline static unsigned long long list_count(list *l)
{
    return l->cnt;
}
inline static void *list_front(list *l)
{
    return l->front;
}
inline static void *list_back(list *l)
{
    return l->back;
}
inline static void *list_prev(void *n)
{
    return ((lnode *)n)->prev;
}
inline static void *list_next(void *n)
{
    return ((lnode *)n)->next;
}
...
inline static unsigned long long listx_count(listx *l)
{
    return l->cnt;
}
