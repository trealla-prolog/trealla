...
builtins g_functions_bifs[] =
{
	...
	{"=:=", 2, fn_iso_neq_2, "+number,+number", false, BLAH},
	{"=\\=", 2, fn_iso_nne_2, "+number,+number", false, BLAH},
	{">", 2, fn_iso_ngt_2, "+number,+number", false, BLAH},
	{">=", 2, fn_iso_nge_2, "+number,+number", false, BLAH},
	{"=<", 2, fn_iso_nle_2, "+number,+number", false, BLAH},
	{"<", 2, fn_iso_nlt_2, "+number,+number", false, BLAH},

	{"==", 2, fn_iso_seq_2, "+term,+term", false, BLAH},
	{"\\==", 2, fn_iso_sne_2, "+term,+term", false, BLAH},
	{"@>", 2, fn_iso_sgt_2, "+term,+term", false, BLAH},
	{"@>=", 2, fn_iso_sge_2, "+term,+term", false, BLAH},
	{"@=<", 2, fn_iso_sle_2, "+term,+term", false, BLAH},
	{"@<", 2, fn_iso_slt_2, "+term,+term", false, BLAH},

	{"is", 2, fn_iso_is_2, "?number,+number", false, BLAH},
	{"return", 1, fn_return_1, "+number,-number", false, BLAH},
	{"float", 1, fn_iso_float_1, "+number", false, BLAH},
	{"integer", 1, fn_iso_integer_1, "+number", false, BLAH},
	...
	{"+", 1, fn_iso_positive_1, "+number,-number", true, BLAH},
	{"-", 1, fn_iso_negative_1, "+number,-number", true, BLAH},
	{"abs", 1, fn_iso_abs_1, "+number,-number", true, BLAH},
	{"sign", 1, fn_iso_sign_1, "+number,-integer", true, BLAH},
	{"epsilon", 0, fn_iso_epsilon_0, "-float", true, BLAH},
	{"pi", 0, fn_iso_pi_0, "-float", true, BLAH},
	{"e", 0, fn_iso_e_0, "-float", true, BLAH},
	{"+", 2, fn_iso_add_2, "+number,+number,-number", true, BLAH},
	{"-", 2, fn_iso_sub_2, "+number,+number,-number", true, BLAH},
	{"*", 2, fn_iso_mul_2, "+number,+number,-float", true, BLAH},
	{"/", 2, fn_iso_divide_2, "+number,+number,-float", true, BLAH},
	{"//", 2, fn_iso_divint_2, "+integer,+integer,-integer", true, BLAH},
	{"div", 2, fn_iso_div_2, "+integer,+integer,-integer", true, BLAH},
	{"mod", 2, fn_iso_mod_2, "+integer,+integer,-integer", true, BLAH},
	{"rem", 2, fn_iso_rem_2, "+integer,+integer,-integer", true, BLAH},
	{"max", 2, fn_iso_max_2, "+number,+number,-number", true, BLAH},
	{"min", 2, fn_iso_min_2, "+number,+number,-number", true, BLAH},
	{"xor", 2, fn_iso_xor_2, "+integer,+integer,-integer", true, BLAH},
	{"/\\", 2, fn_iso_and_2, "+integer,+integer,-integer", true, BLAH},
	{"\\/", 2, fn_iso_or_2, "+integer,+integer,-integer", true, BLAH},
	{"<<", 2, fn_iso_shl_2, "+integer,-integer", true, BLAH},
	{">>", 2, fn_iso_shr_2, "+integer,-integer", true, BLAH},
	{"\\", 1, fn_iso_neg_1, "+integer,-integer", true, BLAH},
	{"**", 2, fn_iso_pow_2, "+number,+number,-float", true, BLAH},
	{"^", 2, fn_iso_powi_2, "+number,+number,-integer", true, BLAH},
	{"exp", 1, fn_iso_exp_1, "+number,-float", true, BLAH},
	{"sqrt", 1, fn_iso_sqrt_1, "+number,-float", true, BLAH},
	{"log", 1, fn_iso_log_1, "+number,-float", true, BLAH},

	{"sin", 1, fn_iso_sin_1, "+number,-float", true, BLAH},
	{"cos", 1, fn_iso_cos_1, "+number,-float", true, BLAH},
	{"tan", 1, fn_iso_tan_1, "+number,-float", true, BLAH},
	{"asin", 1, fn_iso_asin_1, "+number,-float", true, BLAH},
	{"acos", 1, fn_iso_acos_1, "+number,-float", true, BLAH},
	{"atan", 1, fn_iso_atan_1, "+number,-float", true, BLAH},

	{"sinh", 1, fn_sinh_1, "+number,-float", true, BLAH},
	{"cosh", 1, fn_cosh_1, "+number,-float", true, BLAH},
	{"tanh", 1, fn_tanh_1, "+number,-float", true, BLAH},
	{"asinh", 1, fn_asinh_1, "+number,-float", true, BLAH},
	{"acosh", 1, fn_acosh_1, "+number,-float", true, BLAH},
	{"atanh", 1, fn_atanh_1, "+number,-float", true, BLAH},

	{"atan2", 2, fn_iso_atan2_2, "+number,+number,-float", true, BLAH},
	{"copysign", 2, fn_iso_copysign_2, "+number,-number", true, BLAH},
	{"truncate", 1, fn_iso_truncate_1, "+float,-integer", true, BLAH},
	{"round", 1, fn_iso_round_1, "+float,-integer", true, BLAH},
	{"ceiling", 1, fn_iso_ceiling_1, "+float,-integer", true, BLAH},
	{"floor", 1, fn_iso_floor_1, "+float,-integer", true, BLAH},
	{"float_integer_part", 1, fn_iso_float_integer_part_1, "+float,-integer", true, BLAH},
	{"float_fractional_part", 1, fn_iso_float_fractional_part_1, "+float,-float", true, BLAH},

	{"log", 2, fn_log_2, "+number,+number,-float", true, BLAH},
	{"log10", 1, fn_log10_1, "+number,-float", true, BLAH},
	{"random_integer", 0, fn_random_integer_0, "-integer", true, BLAH},
	{"random_float", 0, fn_random_float_0, "-float", true, BLAH},
	{"rand", 0, fn_rand_0, "-integer", true, BLAH},
	{"gcd", 2, fn_gcd_2, "+integer,+integer,-integer", true, BLAH},
	{"popcount", 1, fn_popcount_1, "+integer,-integer", true, BLAH},
	{"lsb", 1, fn_lsb_1, "+integer,-integer", true, BLAH},
	{"msb", 1, fn_msb_1, "+integer,-integer", true, BLAH},
